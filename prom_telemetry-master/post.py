        ...
        if(serialPort.in_waiting>0):
            ...
            if lastmes != '':
                ...
                if isjson(lastmes) :
                    ...
                    #print(res)
                    #response = requests.post('http://52.59.203.14:3000/api/live/push/custom_stream_id', data='sma,host=smar ' + res, headers={'Authorization':'Bearer '+ 'eyJrIjoiMm03c0lXRWY0VGxrM0Vmd2hBelN6NWdtQ3ZSMHZLMTAiLCJuIjoidGVsIiwiaWQiOjF9'})
